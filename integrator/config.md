...
> **Примечание**: использование атрибута логирования `userNameColumn` и соответствующего ему параметра `:username`  заметно увеличивает время выполнения операции логирования. В связи с этим рекомендуется не использовать их без необходимости.
