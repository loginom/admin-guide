...
Чтобы активировать ключ Guardant SP, запустите мастер активации GuardantActivationWizard.exe (при установке Loginom по умолчанию находится в папке `C:\Program Files\BaseGroup\Guardant`) и следуйте его указаниям:
